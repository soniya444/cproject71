...
int xor_decrypt(const char *encrypted, const char *key, char *decrypted)
{
   return xor_encrypt(encrypted, key, decrypted);
}
...
int main()
{
   ...
   xor_encrypt(msg, key1, encrypted);
  ...
  printf("Encrypted message: %s\n", encrypted);
   ...
   xor_decrypt(encrypted, key2, decrypted);
